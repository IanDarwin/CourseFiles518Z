...
public class ExpensesProvider extends ContentProvider {
    ...
    // Briefly examine the code in the static block below 
    static {
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case EXPENSES:
            	// use the DAO to delete the expenses by where clause
            ...
            case EXPENSES_ID:
                // extract the expenseId from the URI
            	long expenseId = ContentUris.parseId(uri);
            	// use the DAO to delete the expenses by id
	...
	public String getType(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case EXPENSES:
            	// Return the content type Expense.ExpenseItem.CONTENT_TYPE
                return Expense.ExpenseItem.CONTENT_TYPE;
            // If the pattern is for expense IDs, returns the expense ID content type.
            case EXPENSES_ID:
            	// Return the content type Expense.ExpenseItem.CONTENT_ITEM_TYPE
	...
	public Uri insert(Uri uri, ContentValues values) {
	        ...
	        // call the insertExpense method on the DAO
	...
	public boolean onCreate() {
		// Create an instance of the DAO (you can get the context with getContext())
	...
	public Cursor query(Uri uri, String[] projection, String selection,
	        ...
	        */
		   // decide which action to take by matching the supplied URI
	       switch (sUriMatcher.match(uri)) {
	           
	           case EXPENSES:
	        	   // If the incoming URI is for expenses, call the queryExpenses method on the DAO	        	   
	        	   // call queryExpenses. The arguments you need were all passed into this method
	           ...
	           case EXPENSES_ID:
	        	   ...
	        	   // Retrieve the ID of the expense to search for from the uri passed into this method
	        	   // Hint: use a ContentUris method
	        	   
	        	   long expenseId = ContentUris.parseId(uri);
	        	   
	        	   // Call queryExpenseById on the DAO to perform the query
	       ...
	       // return the newly retrieved cursor
